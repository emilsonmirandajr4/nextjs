...
"[project]/node_modules/@twicpics/components/react/module.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const n = (e)=>{
    if (!e) return;
    const { attributes: t, element: o, elementName: r, value: s } = e, i = o || document.createElement(r || "div");
    if (t && i instanceof HTMLElement) for (const [e, o] of Object.entries(t))i.setAttribute(e, String(o));
    if (s) if ("string" == typeof s) i.innerHTML = s;
    else for (const e of Array.isArray(s) ? s : [
        s
    ]){
        const t = n(e);
        t && i.appendChild(t);
    ...
    return i;
}, r = /px$/, s = (e)=>Number(e.replace(r, "")), i = "undefined" != typeof document, a = ()=>{}, c = (e, { filter: t, defaultValue: o } = {})=>(n)=>{
        let r;
        return n && `${n}`.replace(e, (e, t)=>r = t), (t ? t(r) : r) || o;
    }, d = (e)=>{
    throw new Error(((e)=>`twicpics-components ${e}`)(e));
}, l = (e, { border: t = "\\s", regExpFlags: o } = {})=>new RegExp(`^(?:${t})*(${Array.isArray(e) ? e.join("|") : e})(?:${t})*$`, o), p = {
    breakpoints: {
        xs: 320,
        sm: 640,
        md: 768,
    ...
    path: "",
    step: void 0
}, m = i && window, u = i ? m["~ TPCC"] || (m["~ TPCC"] = p) : p, f = ()=>`.twic-w>.${u.class}-background-done+div,.twic-w>.${u.class}-done+div,.twic-w>.${u.class}-poster-done+div{opacity:0 !important}.twic-w>.${u.class}-done,.twic-w>.${u.class}-poster-done{transform:none !important}`, h = (e)=>`data-${u.class}-${e}`, g = (e)=>{
    const { breakpoints: t = {}, debug: o, domain: r, class: s, env: c, handleShadowDom: d, maxDPR: l, path: p } = e;
    u.breakpoints = Object.assign(Object.assign({}, u.breakpoints), t), u.class = s || u.class, u.domain = r, u.env = o ? "debug" : c, u.maxDPR = Math.max(1, l || 2), u.path = p, u.handleShadowDom = d && i ? ((e)=>{
        const t = new WeakSet;
        return (o)=>{
            for(; o && !t.has(o);){
                t.add(o);
                const { parentNode: r } = o;
                if (!r && o instanceof ShadowRoot) {
                    if ("closed" === o.mode) throw new Error("cannot use TwicPics components in closed ShadowRoot");
                    n({
                        element: o,
                        value: {
                            elementName: "style",
                            value: `.twic-i{overflow:hidden}.twic-w,.twic-w *{border:none;margin:0;overflow:hidden;padding:0}.twic-w{overflow:hidden;position:relative;padding-top:100%;width:100%;padding-top:calc(100% / var(--twic-ratio,1))}.twic-w>*{display:block;height:100%;left:0;position:absolute;top:0;width:100%;transition-property:opacity,transform;will-change:opacity,transform;background-size:cover;background-position:center;background-repeat:no-repeat;object-fit:cover;object-position:center;transition-delay:0s;transition-duration:.4s;transition-timing-function:ease;object-fit:var(--twic-mode,cover);object-position:var(--twic-position,center);transition-delay:var(--twic-transition-delay,0s);transition-duration:var(--twic-transition-duration,400ms);transition-timing-function:var(--twic-transition-timing-function,ease)}.twic-w>div{background-repeat:no-repeat;background-size:cover;background-position:center;background-size:var(--twic-mode,cover);background-position:var(--twic-position,center);font-size:calc(1px / var(--twic-ratio,1))}.twic-w>img:not([src]),.twic-w>img[src=\"\"]{visibility:hidden}.twic-w.twic-tz>img{transform:scale(0)}.twic-w.twic-tf>div{opacity:1}.twic-d{display:block}.twic-offline{background-color:#ccc}.twic-offline.twic-nosrc{background-color:#fd0016}.twic-offline>*{display:none}:root{--twic-zoom:0}.twic-z{position:relative}.twic-m{left:0;position:absolute;top:0;z-index:1}.twic-m>*{display:none;transition:none;width:calc(max(var(--twic-zoom),1) * 100%);height:calc(max(var(--twic-zoom),1) * 100%);transform:translate3d(calc((1 - max(var(--twic-zoom),1)) * var(--twic-xr,0) * 1px),calc((1 - max(var(--twic-zoom),1)) * var(--twic-yr,0) * 1px),0)}.twic-m:hover>*{display:block}.twic-m:hover+div,twicmedia:hover+twicmedia{opacity:0}.twic-p{border:none;margin:0;overflow:hidden;padding:0}.twic-p>img{display:block;object-fit:cover;object-position:center;width:100%;height:100%}${f()}`
                        }
                    }), (o = o.host) && o.setAttribute(e, "");
                } else o = r;
            }
        };
    })(h("component")) : a;
}, b = /^(?:(auth|placeholder|rel)|(image|media|video)|[^:]*):(\/*)((v[0-9]+(?=[/?]))?[^?]*(\?.*)?)$/, v = (e)=>{
    const t = e && b.exec(e), { domain: o = "" } = u;
    return {
        isAbsolute: e.slice(0, o.length + 1) === `${o}/`,
        isSpecial: t && void 0 !== t[1]
    };
}, $ = ({ context: e, inspect: t, output: o, quality: n, src: r, transform: s })=>{
    const { domain: i } = u, { isAbsolute: a } = v(r), c = a ? `media:${r.slice(`${i}/`.length)}` : r, d = b.exec(c), l = d && d[2], p = o ? `/output=${o}` : "", m = l ? d[4] : c, f = n ? `/quality=${n}` : "", h = t ? "/inspect" : "", g = (({ height: e, mode: t = "cover", width: o }, n)=>{
        if (n && (o || e)) {
            const r = e || "-", s = o || "-";
            return n.replace(/(\/*\*)/g, `/${t}=${s}x${r}`).replace(/WxH/g, `${s}x${r}`);
        }
        return n;
    })(e, s);
    return `${i}/${d && (d[1] || d[5]) ? `v1${g}${p}${f}${h}/${l ? `${d[2]}:${m}` : m}` : `${m}${d && d[6] ? "&" : "?"}twic=v1${g}${p}${h}${f}`}`;
}, y = (e, t)=>"cover" === (e || "cover") && void 0 !== t ? "" : "/*", w = [
    "center"
];
for (const e of [
    "",
...
const x = /(^https?:\/\/[^/]+)\/*$/, j = l([
    ...
    "none",
    "preview"
], E = l(S), D = /^\/*(.+?)\/*$/, z = l("(\\d+(?:\\.\\d+)?)(?:\\s*[\\/:]\\s*(\\d+(?:\\.\\d+)?))?|(none)"), M = l("(\\d+\\.?\\d*)|(css)", {
    regExpFlags: "i"
}), R = (e)=>!isNaN(e) && e > 0, C = /^((image|media|video):)?\/*/, A = c(l("(?:.|\n)*?")), H = l(".+?", {
    border: "[\\s\\/]"
}), W = {
    true: !0,
    false: !1,
    "": !0
}, F = (e)=>"boolean" == typeof e ? e : void 0 !== e && W[e.trim()], I = /(?:§(?<breakpoint>xs|sm|md|lg|xl|2xl|\d*)\s+)?(?<value>[^§]+)/gm, B = (e, t)=>(o)=>{
        const n = {
            0: e(t)
        }, r = (o || "").toString().trim().replace(/(?:^|\s|,)@/g, "§");
        if (r) {
            let o;
            for(; null !== (o = I.exec(r));){
                const { breakpoint: r, value: s } = o.groups || {}, i = Number(r || "0");
                n[isNaN(i) ? u.breakpoints[r] : i] = e(s ? s.replace(/\s*,+\s*$/g, "") : t);
            }
        }
        return n;
    }, L = (e)=>{
    ...
    return R(e) ? e : void 0;
}, V = /\b(?:(left|right)|(bottom|top))\b/g, q = (e)=>{
    const t = A(e);
    let o, n;
    if (t) {
        let e;
        for(; e = V.exec(t);)e[1] ? o = e[1] : n = e[2];
    }
    return {
        x: o,
        y: n
    };
}, Y = B(q), J = (e)=>A(e) || "", X = L, G = A, K = A, Q = F, U = (e)=>{
    const t = A(e);
    return x.test(t) ? t.replace(x, "$1") : void 0;
}, Z = L, _ = F, ee = c(N), te = c(j), oe = (e)=>{
    const t = A(e);
    return "none" === t ? "" : t;
}, ne = B(oe), re = L, se = F, ie = (e)=>{
    const t = L(e);
    return t >= 1 ? t : void 0;
}, ae = c(P), ce = B(ae, "cover"), de = (e)=>{
    const t = A(e);
    return t ? t.replace(D, "$1/") : "";
}, le = A, pe = B(le), me = (e)=>{
    const t = c(H, {
        filter: (e)=>e && e.replace(/^\/*(.*[^/])\/*$/, "$1")
    })(e);
    return "none" === t ? "" : t;
}, ue = B(me), fe = (e)=>{
    if ("none" === e) return 0;
    let t;
    if (e) if ("number" == typeof e) t = 1 / e;
    else {
        const o = z.exec(e);
        if (o) {
            const [, , e, n] = o;
            t = (n ? Number(n) : 1) / Number(e);
        } else t = 1;
    }
    return R(t) ? t : void 0;
}, he = B(fe, 1), ge = (e)=>{
    ...
    return t ? "" : void 0;
}, be = (e)=>A(e) || null, ve = B((e)=>{
    const t = A(e);
    return t && t.replace(/\n\s*/g, "");
}), $e = (e)=>{
    if ("offline" === u.env) return "";
    const t = A(e) || "placeholder:red", { isAbsolute: o, isSpecial: n } = v(t);
    return n ? t : o ? `media:${t.slice(`${u.domain}/`.length)}` : t.replace(C, `media:${u.path}`);
}, ye = L, we = L, Oe = (e)=>e && e.trim(), xe = {
    true: "fade",
    false: "none",
    fade: "fade",
    zoom: "zoom",
    ...
    if ("string" == typeof e) {
        const t = M.exec(e);
        if (t && t[3]) return !0;
        e = t && t[2] ? Number(t[2]) : void 0;
    }
    return R(e) && e > 1 ? e : void 0;
}, Pe = [
    [
        "anticipation",
        "anticipation"
    ...
    if (i) {
        ...
        Pe.forEach((o)=>{
            const [n, r] = o;
            e.hasOwnProperty(n) && e[n] && t.push(`${r}=${e[n]}`);
        });
        const { scriptElementId: o } = e;
        n({
        ...
        document.head.appendChild(r), document.addEventListener("astro:after-swap", ()=>document.head.appendChild(r));
    }
}, Ee = (e)=>{
    e || d("install options not provided");
    const { domain: t, env: o, path: n } = e;
    t && x.test(t) || d(`install domain "${t}" is invalid`), n && O.test(n) && d(`install path "${n}" is invalid`), o && !j.test(o) && d(`install env "${o}" is invalid`);
}, De = (e)=>{
    Ee(e);
    const { domain: t, env: o, path: n } = e;
...
const Me = ({ x: e, y: t }, o, n)=>"contain" === o && (n || (t ? e ? `${t} ${e}` : t : e)), Re = ({ anchor: { x: e, y: t }, debug: o, focus: n, mode: r, preTransform: s, refit: i })=>{
    const a = t ? e ? `${t}-${e}` : t : e, c = "contain" !== r && void 0 === i && (n || a), d = ((e, t, o)=>void 0 !== o && `${"contain" === t ? "auto" : "WxH"}${o ? `(${o})` : ""}${e && "contain" !== t ? `@${e}` : ""}`)(a, r, i);
    return `${o ? "/debug" : ""}${s ? `/${s}` : ""}${c ? `/focus=${c}` : ""}${d ? `/refit=${d}` : ""}`;
}, Ce = (e, t, o)=>{
    const n = {};
    return t && (n.transitionDuration = t), e && (n.transitionDelay = e), o && (n.transitionTimingFunction = o), n;
}, Ae = (e, t, o, n, r)=>Object.assign(Object.assign(Object.assign(Object.assign({}, "img" === n && {
        alt: e || ""
    }), ("img" === n || "video" === n) && {
        crossOrigin: t
    }), "img" === n && {
        ...
        referrerPolicy: r
    }), He = (e, t, o, n, r, s, i, a, c, d, l, p, m, u, f)=>{
    const h = Ce(l, p, m);
    f({
        anchor: e,
        focus: t,
        ...
        transitions: d,
        videoOptions: u
    }), o && (h.backgroundSize = o);
    const g = Me(e, o, r);
    return g && (h.backgroundPosition = g), h;
}, We = {
    img: "objectPosition",
    ...
    const a = Ce(r, s, i), c = Me(e, o, n);
    return c && (a[We[t] || "backgroundPosition"] = c), o && (a[Fe[t] || "backgroundSize"] = o), a;
}, Be = (e, t, o)=>{
    const n = [
        "twic-w"
    ];
    return e && n.push(e), o.hasOwnProperty("none") || (o.hasOwnProperty("fade") && n.push("twic-tf"), o.hasOwnProperty("zoom") && n.push("twic-tz")), "offline" === u.env && (n.push("twic-offline"), t || n.push("twic-nosrc")), n.join(" ");
}, Le = (e)=>0 === e ? {
        height: "100%",
        paddingTop: "0"
    } : {
        paddingTop: void 0 === e ? "" : 100 * e + "%"
    }, Ve = (e)=>{
    const t = {};
    return "boolean" != typeof e && e && (t["--twic-zoom"] = `${e}`), t;
}, qe = new WeakMap, Ye = i && "undefined" != typeof MutationObserver && new MutationObserver((e)=>{
    for (const { target: t } of e){
        const e = qe.get(t);
        e && e.handleState();
    }
}), Je = i && "undefined" != typeof ResizeObserver && new ResizeObserver((e)=>{
    for (const { target: t } of e){
        const e = qe.get(t);
        e && e.refreshBackground();
    }
}), Xe = new RegExp(`(?:\\s*)(?:${u.class}(?:-background)*-)(done|error|loading)`);
class Ge {
    constructor(e = void 0){
        this.handleState = ()=>{
            if (this.stateHandler) {
                let e = "new";
                const { className: t } = this.media, o = Xe.exec(t);
                o && ([, e] = o), this.stateHandler(e);
            }
        }, this.refreshBackground = ((e)=>{
            let t;
            ...
            return (...n)=>{
                !t && o.leading && e(...n), clearTimeout(t), t = setTimeout(()=>{
                    t = void 0, o.trailing && e(...n);
                }, o.ms);
            };
        })(()=>{
            if (this.media && this.placeholderData) {
                const e = this.media.nextElementSibling, t = ((e, { anchor: t, focus: o, mode: n, placeholder: r, preTransform: i, src: a, ratio: c, refit: d, transitions: l, videoOptions: p })=>{
                    if (!u.domain || !e || !r || l.hasOwnProperty("zoom")) return "";
                    const m = getComputedStyle(e), f = n || ae(m.backgroundSize) || "cover";
                    let h;
                    h = 0 === c ? "contain" === f ? 1 : s(m.height) / Math.max(1, s(m.width)) : null != c ? c : s(m.fontSize);
                    let g = 1e3, b = 1e3;
                    h < 1 ? g *= h : b /= h;
                    const { videoTransform: v } = p || {}, w = `${Re({
                        anchor: t,
                        focus: o,
                        mode: n,
                        preTransform: i,
                    ...
                    return $({
                        context: {
                            height: Math.max(1, Math.round(g)),
                            mode: f,
                            width: Math.max(1, Math.round(b))
                        },
                        transform: w,
                        src: a,
                        output: r
                    });
                })(e, this.placeholderData);
                t && t !== this.savedWrapperBackground && (this.savedWrapperBackground = t, e.style.backgroundImage = `url(${JSON.stringify(t)})`);
            }
        }), this.setMedia = (e)=>{
            e && (u.handleShadowDom(e), this.media = e, qe.set(this.media, this), Ye && (Ye.observe(this.media, {
                attributes: !0,
                attributeFilter: [
                    "class"
                ]
            }), this.handleState()), Je && Je.observe(this.media));
        }, this.setPlaceholderData = (e)=>{
            this.placeholderData = e, this.media && this.refreshBackground();
        }, this.destroy = ()=>{
            this.media && this.media && Je && Je.unobserve(this.media);
        }, this.stateHandler = e;
    }
}
const Ke = (e)=>null == e;
class Qe extends Error {
    constructor({ componentName: e, expectedTypes: t, expectedValues: o, props: n, propName: r }){
        const s = t || o;
        super(`Invalid prop '${r}'${o ? ` value '${n[r]}'` : ""}${t ? ` type '${typeof n[r]}'` : ""} supplied to '${e}'${s ? ` expected ${s.length > 1 ? "one of " : ""}${t ? "type " : ""}'${s.join(", ")}'` : ""}.`), this.expected = s && s[0];
    }
}
const Ue = (e)=>(t, o, n)=>{
        const r = [];
        ...
        return Ke(s) || typeof s === e ? t && !t.test(String(s)) ? new Qe(i) : null : new Qe(Object.assign(Object.assign({}, i), {
            expectedTypes: [
                e
            ]
        }));
    }, _e = Ze("boolean"), et = Ze("function"), tt = (e)=>{
    const t = new Set(e);
    return (o, n, r)=>{
        const s = o[n];
        return Ke(s) || t.has(s) ? null : new Qe({
            componentName: r,
            expectedValues: e,
            props: o,
            propName: n
...
}, ot = Ue, nt = Ze("string"), rt = Ue([
    Ze("number"),
    nt
]), st = (n)=>{
    const r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null), s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(new Ge((e)=>{
        n.onStateChange && n.onStateChange({
            target: r,
            state: e
        });
    })).current;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>(s.setMedia(r.current), ()=>{
            s.destroy();
        }), []);
    const i = J(n.alt), a = q(n.anchor), c = "string" == typeof (d = n.bot) ? d.trim() : void 0;
    var d;
    const l = K(n.className), p = _(n.eager), m = oe(n.focus), f = ((e)=>{
        if (!e) return;
        let t;
        const o = T.exec(e);
        if (o) {
    ...
    })(n.mediaTag), b = ae(n.mode), $ = ((e)=>{
        if ("offline" !== u.env && "none" !== e) return E.test(e) ? e : "preview";
    })(n.placeholder), w = le(n.position), O = me(n.preTransform), x = fe(n.ratio), j = ge(n.refit), N = $e(n.src), k = ye(n.step), P = Oe(n.title), S = ((e)=>{
        "boolean" != typeof e && (e = A(e) || !0);
        const t = {};
        return String(e).split(/\s*\+\s*|\s+/).forEach((e)=>t[`${xe[e] || "fade"}`] = !0), t;
    })(n.transition), D = je(n.transitionDelay), z = Ne(n.transitionDuration), M = Te(n.transitionTimingFunction), { videoOptions: R } = n, C = ((e, t)=>v(t).isSpecial ? void 0 : e)($, N);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("div", {
        ...
        className: Be(l, n.src, S),
        style: Le(x),
        title: P
    }, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement(g, Object.assign({
        suppressHydrationWarning: !0,
        ref: r,
        style: Ie(a, g, b, w, D, z, M)
    }, ((e, t, o, n, r, s, i, a, c, d, l, p)=>{
        const m = {}, { videoTransform: f, posterTransform: g } = p || {}, b = Re({
            anchor: e,
            debug: "debug" === u.env,
            focus: n,
            mode: i,
        ...
        return (b || f) && (m[h("transform")] = `${b}${f || ""}${y(i, c) || ""}`), "string" == typeof t && (m[h("bot")] = t || "/"), o && (m[h("eager")] = ""), r && (m[h("intrinsic")] = r), d && ("img" === s || "video" === s ? m[h("src")] = d : m[h("background")] = `url(${d})`), d && "video" === s && (m[h("poster")] = d, m[h("poster-transform")] = `${b}${g || ""}/*/output=image`), void 0 !== l && (m[h("step")] = String(l)), m;
    })(a, c, p, m, f, g, b, O, j, N, k, R), Ae(i, n.crossOrigin, n.decoding, g, n.referrerPolicy))), C && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("div", {
        suppressHydrationWarning: !0,
        style: He(a, m, b, C, w, O, x, j, N, S, D, z, M, R, s.setPlaceholderData)
    }));
};
st.propTypes = {
    alt: nt,
    ...
    transitionTimingFunction: nt
};
const it = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].use ? "fetchPriority" : "fetchpriority", at = (e)=>{
    var { id: t, draggable: o, role: n, style: r, tabIndex: s } = e, i = ze(e, [
        "id",
        "draggable",
        "role",
        "style",
    ...
    return {
        hostProps: Object.assign(Object.assign({}, Object.fromEntries(Object.entries(i).filter(([e])=>e.startsWith("aria-")))), {
            id: t,
            draggable: o,
            role: be(n),
            style: r,
        ...
        mediaProps: Object.assign({}, i)
    };
}, ct = {
    mediaTag: "div"
}, dt = (t)=>{
    const o = Object.assign(Object.assign({}, ct), t), { className: n } = o, r = ze(o, [
        "className"
    ]), { hostProps: s, mediaProps: i } = at(Object.assign({
        role: "img"
    }, r)), a = K(n) || "";
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("div", Object.assign({}, s, {
        className: `twic-i ${a}`
    }), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement(st, Object.assign({}, i, {
        className: ""
    })));
};
dt.propTypes = {
...
const lt = (e, t)=>{
    if (e < 0 || e > t) return Math.min(Math.max(0, e), t);
    let o = 2 * e / t;
    return o < 1 ? t / 2 * o ** 3 : (o -= 2, t / 2 * (o ** 3 + 2));
}, pt = (e)=>{
    e.preventDefault(), e.stopPropagation();
    const t = e.currentTarget, { left: o, top: n, right: r, bottom: s } = t.getBoundingClientRect(), { clientX: i, clientY: a } = e instanceof MouseEvent ? e : e.touches[0];
    t.style.setProperty("--twic-xr", lt(i - o, r - o).toString()), t.style.setProperty("--twic-yr", lt(a - n, s - n).toString());
}, mt = (n)=>{
    const r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null), { hostProps: s, mediaProps: i } = at(Object.assign({
        role: "img"
    }, n));
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ke(n.zoom) && ((e)=>{
            const t = e.firstElementChild;
            t.addEventListener("mousemove", (e)=>pt(e)), t.addEventListener("touchmove", (e)=>pt(e));
        })(r.current);
    }, []);
    const a = K(n.className) || "", c = ke(n.zoom);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("div", Object.assign({
        ...
        className: `twic-i ${a} ${c ? "twic-z" : ""}`,
        style: Object.assign(Object.assign({}, s.style), Ve(c))
    }), c && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement(st, Object.assign({}, i, {
        className: "twic-m",
        mediaTag: "div",
        mode: "cover"
    })), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement(st, Object.assign({}, i, {
...
const ut = (e)=>{
    ...
    const t = {
        anticipation: X(e.anticipation),
        breakpoints: e.breakpoints,
        class: G(e.class),
        debug: Q(e.debug),
        domain: U(e.domain),
        env: te(e.env),
        handleShadowDom: se(e.handleShadowDom),
        maxDPR: ie(e.maxDPR),
        path: de(e.path),
        scriptElementId: "twicpics-script",
        step: ye(e.step)
    };
    return g(t), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        document.getElementById(t.scriptElementId) || Se(t);
    }, []), null;
};
ut.propTypes = {
    anticipation: rt,
...
const ft = (t)=>{
    const o = J(t.alt), n = Y(t.anchor), r = K(t.className) || "", s = _(t.eager), i = ee(t.fetchpriority), a = ne(t.focus), c = ce(t.mode), d = pe(t.position), l = ue(t.preTransform), p = he(t.ratio), m = ge(t.refit), f = $e(t.src), h = ve(t.sizes), g = Oe(t.title), b = ((e, t, o, n, r, s, i, a, c, d, l)=>{
        if (!u.domain) return;
        const p = ((e, t, o, n, r, s, i)=>{
            var a;
            const c = new Set([
                ...Object.keys(e).map(Number),
                ...Object.keys(t).map(Number),
                ...Object.keys(o).map(Number),
                ...Object.keys(n).map(Number),
                ...Object.keys(r).map(Number),
                ...Object.keys(s).map(Number),
                ...Object.keys(i).map(Number)
            ]), d = [
                ...new Set([
                    ...Object.values(u.breakpoints),
                    ...Array.from(c).filter((e)=>e > 0)
                ])
            ].sort((e, t)=>e - t), l = Array.from(c).sort((e, t)=>e - t).map((a)=>({
                    breakpoint: a,
                    anchor: e[a],
                    focus: t[a],
                    mode: o[a],
            ...
            for(let e = 1; e < l.length; e++){
                const t = l[e - 1], o = l[e];
                for (const e of Object.keys(l[0]))o[e] = null !== (a = o[e]) && void 0 !== a ? a : t[e];
            }
            return l.map((e, t)=>{
                var o, n;
                const { anchor: r, breakpoint: s, focus: i, mode: a, position: c, preTransform: p, ratio: m, sizes: u } = e, f = null !== (n = null === (o = l[t + 1]) || void 0 === o ? void 0 : o.breakpoint) && void 0 !== n ? n : void 0, h = s || f || Math.max(...d);
                return {
                    anchor: r,
                    breakpoint: s,
                    focus: i,
                    ...
                    preTransform: p,
                    ratio: m,
                    resolutions: d.filter((e)=>e >= s && (void 0 === f || e < f || 0 === s && e <= f)),
                    sizes: u,
                    width: h,
                    height: m ? `${Math.round(h * m)}` : void 0
                };
            }).sort((e, t)=>t.breakpoint - e.breakpoint);
        })(e, n, r, s, i, a, d), m = p.map((e, n)=>{
            const { anchor: r, focus: s, media: i, mode: a, position: d, preTransform: m, ratio: f, resolutions: h, sizes: g, width: b, height: v } = e, w = "contain" === a ? "inside" : a, O = Me(r, a, d), x = `${Re({
                anchor: r,
                focus: s,
                mode: a,
                preTransform: m,
                refit: c
            })}${y(a, c) || ""}${O ? `@${O.replace(/(\s)/g, "-")}` : ""}`, j = new Set;
            for(let e = 1; e <= u.maxDPR; e++)h.forEach((t)=>j.add(t * e));
            const N = new Map;
            Array.from(j).sort((e, t)=>t - e).forEach((e)=>{
                N.set(e, $({
                    context: {
                        height: f ? Math.round(e * f) : void 0,
                        mode: w,
                        width: e
                    },
                    transform: x,
            ...
            return T.srcSet = Array.from(N, ([e, t])=>`${t} ${e}w`).join(","), n === p.length - 1 ? (T.fetchPriority = t ? o || "high" : o, T.loading = t ? "eager" : "lazy", T.src = N.get(b)) : T.media = i, T;
        });
        return {
            img: m.pop(),
            sources: m
        };
    })(n, s, i, a, c, d, l, p, m, h, f), v = (null == b ? void 0 : b.img) || {}, { fetchPriority: w } = v, O = ze(v, [
        "fetchPriority"
    ]), x = Object.assign(Object.assign({}, Ae(o, t.crossOrigin, t.decoding, "img", t.referrerPolicy)), {
        [it]: w
    }), { hostProps: j } = at(Object.assign({
        role: "img"
    }, t));
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("div", Object.assign({}, j, {
        className: `twic-i ${r}`
    }), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("picture", {
        className: "twic-p",
        title: g
    }, (null == b ? void 0 : b.sources) && b.sources.map((t, o)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("source", Object.assign({
            key: o
        }, t))), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("img", Object.assign({
        suppressHydrationWarning: !0
    }, x, O))));
};
ft.propTypes = {
...
const ht = (t)=>{
    const o = K(t.className) || "", n = (i = Z(t.duration), a = re(t.from), c = re(t.posterFrom), {
        videoTransform: `${a ? `/from=${a}` : ""}${(d = we(t.to)) ? `/to=${d}` : ""}${i ? `/duration=${i}` : ""}`,
        posterTransform: c || a ? `/from=${void 0 === c ? a : c}` : ""
    }), { hostProps: r, mediaProps: s } = at(t);
    var i, a, c, d;
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("div", Object.assign({}, r, {
        className: `twic-i ${o}`
    }), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement(st, Object.assign({}, s, {
        className: "",
        mediaTag: "video",
        refit: !1,
        videoOptions: n
...
//# sourceMappingURL=node_modules_ad2e2b47._.js.map