...
import { fetchPosts, fetchPostBySlug, usePostsByCategory } from '../../../../../src/hooks/usePosts';
import { decodeHtmlEntities } from '../../../../../src/lib/wordpress-utils';
                  ...
                  <div className="relative px-4 py-3 border-b border-red-800 bg-gradient-to-r from-red-600 via-rose-600 to-red-800 overflow-hidden">
                    ...
                    <div className="relative flex items-center gap-3">
                      <div className="relative">
                        <div className="absolute inset-0 bg-red-300 blur-sm opacity-100"></div>
